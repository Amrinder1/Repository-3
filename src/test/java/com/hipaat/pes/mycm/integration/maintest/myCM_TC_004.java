...
public class myCM_TC_004 extends DriverManager {
    ...
    public void myCM_TC_004() throws InterruptedException{
        try {
    ...
    Assert.assertTrue(Title1.contains("Restrict Disclosure of Healthcare Information"));
    ...
    String act_PtName = driver.findElement(By.id("detail:fullName")).getText();
    String exp_PtName = "Patient, Ann";
    Assert.assertEquals(act_PtName,exp_PtName);
    System.out.println( "Patient Name  from in policy created in myCM User Portal is reflected in PeS.");
    String act_RWID1 = driver.findElement(By.xpath(".//*[@id='detail:displayId']")).getText();
    String exp_RWID1 = "16-03-83";
    Assert.assertEquals(act_RWID1,exp_RWID1);
    System.out.println( "Patient RWID from in policy created in myCM User Portal is reflected in PeS.");
    ...
    String act_PtName1 = driver.findElement(By.id("detail:fullName")).getText();
    String exp_PtName1 = "Patient, Ann";
    Assert.assertEquals(act_PtName1,exp_PtName1);
    System.out.println( "Patient Name from in policy created in myCM Patient Portal is reflected in PeS.");
    String act_RWID2 = driver.findElement(By.xpath(".//*[@id='detail:description']")).getText();
    String exp_RWID2 = "16-03-83";
    Assert.assertEquals(act_RWID1,exp_RWID1);
    System.out.println( "Patient RWID from in policy created in myCM Patient Portal is reflected in PeS.");
