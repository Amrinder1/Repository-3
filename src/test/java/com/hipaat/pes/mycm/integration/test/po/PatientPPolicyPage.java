...
public class PatientPPolicyPage {
	WebDriver driver;
	
	public PatientPPolicyPage(WebDriver d) {
		
		driver = d;
		PageFactory.initElements(d, this);// additional method
	}
		
	// Mapped with Logout button on Patient Portal Patient Page.
	@FindBy(id = "confirmed:confirmedForm:j_id_jsp_153476521_6pc9")
	@CacheLookup
	WebElement btnLogout;
		
	// Mapped with ViewConsentPolicies on Patient Portal Patient Page.
	@FindBy(linkText = "View Consent Policies")
    @CacheLookup
	WebElement lnkViewConsentPolicies;
	
	// Mapped with back button on Patient Portal Patient Page.
	@FindBy(xpath = ".//*[@id='consentminder:j_id_jsp_247101692_52pc2:j_id_jsp_247101692_53pc2']/span")
	@CacheLookup
	WebElement btnback;
	
	// Mapped with ViewTemplateList on Patient Portal Patient Page.
	@FindBy(linkText = "View Template List")
	@CacheLookup
	WebElement lnkViewTemplateList ;
	
	// Mapped with Allow Disclosure of Healthcare Information on Patient Portal Patient Page.
	@FindBy(linkText = "Allow Disclosure of Healthcare Information")
	@CacheLookup
	WebElement lnkAllowDisclosureHI;
	
	// Mapped with Restrict Disclosure of Healthcare Information on Patient Portal Patient Page.
	@FindBy(linkText = "Restrict Disclosure of Healthcare Information")
	@CacheLookup
	WebElement lnkRestrictDisclosureHI;

	// Mapped with Allow Use of Healthcare Information on Patient Portal Patient Page.
	@FindBy(linkText = "Allow Use of Healthcare Information")
	@CacheLookup
	WebElement lnkAllowUseHI;
	
	// Mapped with Restrict Use of Healthcare Information on Patient Portal Patient Page.
	@FindBy(linkText = "Restrict Use of Healthcare Information")
	@CacheLookup
	WebElement lnkRestrictUseHI;
	
	// Mapped with checkbox button to select directive outcome as None  on Patient Portal Patient Page.
	...
	// Mapped with radio button consenter as Patient on Patient Portal Patient Page.
	@FindBy(id = "myCM_consenterPatient")
	@CacheLookup
	WebElement rdmyCMonsenterPatient;
	
	// Mapped with radio button consenter as Representative on Patient Portal Patient Page.
	@FindBy(id = "myCM_consenterRepresentative")
	@CacheLookup
	WebElement rdmyCMconsenterRepresentative;
	
	// Mapped with myCM consenter Representative Name field on Patient Portal Patient Page.
	@FindBy(id = "myCM_consenterName")
	@CacheLookup
	WebElement txtmyCMconsRepName;
	
	// Mapped with myCM consenter Representative role field on Patient Portal Patient Page.
	@FindBy(id = "myCM_consenterRole")
	@CacheLookup
	WebElement txtmyCMconsRepRelation;
	
	// Mapped with continue button on Patient Portal Patient Page.
	@FindBy(id = "consentminder:j_id_jsp_247101692_40pc2:j_id_jsp_247101692_49pc2")
	@CacheLookup
	WebElement btncontinue;
    
	// Mapped with save button on Patient Portal Patient Page.
    ...
    public void clickLogOutPatient() {
	    	btnLogout.click();
	    }
}
