...
public class myCM_TC_008 extends DriverManager {
    ...
    public void myCM_TC_008() throws InterruptedException {
        try {
        ...
        //Scenario 1: Step 1 - LogIn to Patient Portal then select patient and add new Policy.  
       ...
       // Thread.sleep(2000);
        ...
        // Assertion to check Policy created successfully in Scenario 1 Step 1
        ...
        //Scenario 2: Step 1 - LogIn into User Portal then select patient and add new Policy .
        ...
        UPP1.clickbtnsave();
        UPP1.clickbtnback();
        // Assertion to check Policy created successfully in Scenario 2 Step 1
        ...
        // Scenario 1 & 2: Step 2 - LogIn into PeS and revoke policy created in Step 1.
        ...
        // Assertion to verify Policy Pes in Scenario 2 
        ...
        // AC01- Policy successfully revoked in Step 2 Scenario 2.
        ...
        Thread.sleep(2000);
        // Assertion to verify Policy Pes in Scenario 1
        ...
        //AC02- Policy successfully revoked in Step 2 Scenario 1.
        String act_info2 = driver.findElement(By.xpath(".//*[@id='infoMessagesDialog']/table/tbody/tr/td")).getText();
        String exp_info2 = "Policy was revoked successfully.";
        Assert.assertEquals(act_info2, exp_info2);
        softassert.assertAll();
        ActPl2.clicklogout();
        
        // Scenario 1: Step 3 - LogIn into Patient Portal and verify policy created in step1 is not there in view consent policies  
        ...
        // AC01- Assertion to confirm Policy successfully revoked is verified in Step 3 for Scenario 1.
        Assert.assertFalse(isElementPresent(By.linkText("Restrict Disclosure of Healthcare Information")));
        System.out.println( "Policy revoked in Pes does not exist in Patient Portal successfully verified.");
        ...
        // Scenario 1: Step 3 - LogIn into User Portal and verify policy created in step1 is not there in view consent policies.    
        ...
        // AC02- Assertion to confirm Policy successfully revoked is verified in Step 3 for Scenario 2.
        Assert.assertFalse(isElementPresent(By.linkText("Allow Use of Healthcare Information")));
        System.out.println( "Policy revoked in Pes does not exist in User Portal successfully verified.");
