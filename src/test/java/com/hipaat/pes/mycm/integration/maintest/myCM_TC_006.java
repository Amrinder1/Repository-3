...
public class myCM_TC_006 extends DriverManager {
    ...
    public void myCM_TC_006() throws InterruptedException {
             try {
        ...
        // Step 1 - LogIn to Pes  and adding new policy 
        ...
        // AC01- Assertion to verify Policy successfully created in pes.
        ...
        //Step 2 - LogIn to Patient Portal and verify policy created in Step 1.
        ...
        // AC02- Assertion confirming policy verified for Patient Portal in Step 2.
        WebElement policy1 = driver.findElement(By.linkText("Deny All Policy 1"));
        String Title1 = policy1.getText();
        Assert.assertTrue(Title1.contains("Deny All Policy 1"));
        System.out.println( "Policy created in Pes Portal is successfully verified in Patient Portal ");
        PPP1.clickLogOutPatient();
       
        //Step 3 - LogIn to User Portal and verify policy created in Step 1.
        ...
        // AC03- Assertion confirming policy verified for Patient Portal in Step 3
        WebElement policy2 = driver.findElement(By.linkText("Deny All Policy 1"));
        String Title2 = policy2.getText();
        Assert.assertTrue(Title2.contains("Deny All Policy 1"));
        System.out.println( "Policy created in Pes Patient Portal is successfully verified in User Portal ");
